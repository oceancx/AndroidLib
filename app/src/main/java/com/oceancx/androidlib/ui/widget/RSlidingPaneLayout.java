 ...
 * in the RSlidingPaneLayout. When this occurs the user may slide the topmost view out of the way
 ...
 * <p/>
 * <p>Thanks to this sliding behavior, RSlidingPaneLayout may be suitable for creating layouts
 ...
 * <p/>
 * <p>RSlidingPaneLayout is distinct from a navigation drawer as described in the design
 * guide and should not be used in the same scenarios. RSlidingPaneLayout should be thought
 * of only as a way to allow a two-pane layout normally used on larger screens to adapt to smaller
 * screens in a natural way. The interaction patterns expressed by RSlidingPaneLayout imply
 ...
 * <p/>
 * <p>Appropriate uses of RSlidingPaneLayout include pairings of panes such as a contact list and
 * subordinate interactions with those contacts, or an email thread list with the content pane
 * displaying the contents of the selected thread. Inappropriate uses of RSlidingPaneLayout include
 ...
 * <p/>
 * <p>Like {@link android.widget.LinearLayout LinearLayout}, RSlidingPaneLayout supports
 ...
 */
public class RSlidingPaneLayout extends ViewGroup {
    private static final String TAG = "RSlidingPaneLayout";
    ...
    public RSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public RSlidingPaneLayout(Context context, AttributeSet attrs) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(RSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(RSlidingPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(RSlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(RSlidingPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == RSlidingPaneLayout.this) {
